...
import br.com.jobflix.ui.details.people.PeopleDetailActivity
import org.koin.androidx.viewmodel.ext.android.viewModel

class PeopleSearchFragment : Fragment() {

    private var _binding: FragPeopleSearchBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragPeopleSearchBinding.inflate(inflater, container, false)
        return binding.root
    }
