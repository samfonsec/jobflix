...
class SerieDetailsActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActDetailsBinding.inflate(layoutInflater)
    ...
    private fun setupEpisodesList() {
        with(binding.rvEpisodes) {
            layoutManager = LinearLayoutManager(this@SerieDetailsActivity, LinearLayoutManager.HORIZONTAL, false)
    ...
    private fun onEpisodesResult(episodes: Map<Int, List<Episode>>) {
        ...
        with(binding.spSeasons) {
            show()
            adapter = ArrayAdapter(this@SerieDetailsActivity, android.R.layout.simple_spinner_item, seasons).apply {
    ...
    companion object {
        ...
        fun newInstance(context: Context, serie: Serie) = Intent(context, SerieDetailsActivity::class.java).apply {
